import { Link, SvgIcon, Typography, typographyClasses, type SvgIconProps } from "@mui/material";
...
const Logo = ({ sx, viewBox = '0 0 26 40', showName = true, ...rest }: LogoProps) => {
        ...
        >
            ...
            >
                ...
                <defs>
                    ...
                    >
                        <stop stopColor="#f37825" stopOpacity="0" />
                        <stop offset="1" stopColor="#f37825" />
                    </linearGradient>
                    <linearGradient
                        id={`paint1-${id}`}
                        x1="8.99599"
    ...
    #e79a0c 27.63%,
    #eb2c2c 49.36%,
    ${vars?.palette.text.secondary ?? palette.text.secondary} 50.11%,
    ${vars?.palette.text.secondary ?? palette.text.secondary} 87.87%
  );`,
