import { Person, Lock, WorkOutline, CameraAlt, Logout, Save, TurnedInNot } from "@mui/icons-material";
...
const MENU_ITEMS: { key: TabKey; label: string; icon: React.ReactNode }[] = [
    ...
    { key: "saved-applications", label: "Tin đã lưu", icon: <TurnedInNot sx={{ fontSize: 18 }} /> },
    { key: "saved-organizations", label: "Trường đã lưu", icon: <TurnedInNot sx={{ fontSize: 18 }} /> },
    { key: "logout", label: "Đăng xuất", icon: <Logout sx={{ fontSize: 18 }} /> },
];
                                ...
                                {MENU_ITEMS.map((item) => (
                                    <Stack
                                        ...
                                        sx={{
                                            ...
                                            "&:hover": {
                                                bgcolor: activeTab === item.key ? "#fff3e0" : "#f5f5f5",
                                            },
                                        }}
                                    >
                                        <Box sx={{ color: activeTab === item.key ? "#f36730" : "#9e9e9e" }}>
                                            {item.icon}
                                        </Box>
                                        ...
                                        {activeTab === item.key && (
                                            <Box sx={{
                                                ml: "auto", width: 4, height: 4, borderRadius: "50%",
                                                bgcolor: "#f36730",
                                            }} />
                                        )}
                                    </Stack>
